...
// 4. Get and validate user ID from URL
$editUserId = isset($_GET['id']) ? (int)$_GET['id'] : 0;
if ($editUserId <= 0) {
    header('Location: http://localhost:8080/makueni-west/diocese/settings/admin/users');
    exit;
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Edit User - Makueni West Diocese</title>
    <meta name="Description" content="Edit user account and manage territory assignments" />
...
<body>
                                ...
                                <form id="addUserWizardForm">
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane" id="territory-assignment" role="tabpanel">
                                            ...
                                            <!-- PRIMARY ASSIGNMENT -->
                                            <!-- Display Card (shown when assignment exists) -->
                                            <div id="primaryAssignmentCard" class="card mb-3 border-0 shadow-sm" style="display: none;">
                                                <div class="card-header bg-gradient-primary text-white d-flex align-items-center">
                                                    <i class="ri-star-fill fs-5 me-2"></i>
                                                    <span class="fw-semibold">Primary Assignment</span>
                                                </div>
                                                <div class="card-body bg-light">
                                                    <div class="row g-3">
                                                        <div class="col-md-4">
                                                            <div class="d-flex align-items-start">
                                                                <i class="ri-map-pin-line text-primary fs-5 me-2 mt-1"></i>
                                                                <div>
                                                                    <p class="mb-1 text-muted small">Territory Type</p>
                                                                    <p class="fw-semibold mb-0" id="primaryTerritoryType">-</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="d-flex align-items-start">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p class="fw-semibold mb-0" id="primaryTerritoryName">-</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="d-flex align-items-start">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p class="fw-semibold mb-0" id="primaryRoleName">-</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="mt-3 pt-3 border-top">
                                                        <button type="button" class="btn btn-primary btn-sm" id="changePrimaryBtn">
                                                            <i class="ri-edit-line me-1"></i>Change Assignment
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>

                                            <!-- Form (shown when changing or no assignment exists) -->
                                            <div id="primaryAssignmentForm" class="card mb-3">
                                                <div class="card-header bg-primary text-white">
                                                    <i class="ri-star-fill me-2"></i>Primary Assignment (Required)
                                                </div>
                                                <div class="card-body">
                                                    <div class="alert alert-info" role="alert">
                                                        <i class="ri-information-line me-2"></i>Assign this user to territories with roles. Primary assignment is required.
                                                    </div>
                                                    <div class="row gy-3">
                                                        <!-- Territory Type -->
                                                        <div class="col-md-4">
                                                    ...
                                                    <div class="mt-3" id="cancelPrimaryBtnContainer" style="display: none;">
                                                        <button type="button" class="btn btn-secondary btn-sm" id="cancelPrimaryBtn">
    ...
    <!-- Utils -->
    <script src="http://localhost:8080/makueni-west/assets/js/pages/system-administration/user-management/user-management-utils.js"></script>
    ...
    <script src="http://localhost:8080/makueni-west/assets/js/pages/system-administration/user-management/edit-user-wizard.js"></script>
</body>
