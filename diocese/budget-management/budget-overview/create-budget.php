...
<body>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane show active" id="step1-basic" role="tabpanel">
                                            ...
                                            <div class="mt-4 pt-3 border-top d-flex justify-content-between">
                                                <a href="<?= SITE_URL ?>/diocese/budget-management/budget-overview/all-budgets" class="btn btn-light">
    ...
    <!-- Create Budget JS -->
    <script src="<?= asset_url('/assets/js/pages/budget-management/create-budget.js') ?>"></script>
</body>
