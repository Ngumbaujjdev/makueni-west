                            ...
                            <div class="row justify-content-center mb-5">
                                <div class="col-xl-6">
                                    <p class="mb-0 op-7">
                                        ...
                                        notified. Please try again later or contact support if the
                                        problem persists.
                                    </p>
                                </div>
                            </div>
                            <button onclick="tryAgain()" class="btn btn-primary me-2">
                                <i class="ri-refresh-line align-middle me-1 d-inline-block"></i>
                                TRY AGAIN
                            </button>
