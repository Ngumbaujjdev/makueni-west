                    ...
                    <div class="row align-items-center justify-content-center h-100">
                        <div class="col-xl-7">
                            ...
                            <div class="row justify-content-center mb-5">
                                <div class="col-xl-6">
                                    <p class="mb-0 op-7">
                                        We are sorry for the inconvenience. The page you are trying
                                        to access has been removed or never existed.
                                    </p>
                                </div>
                            </div>
    ...
    function backToDashboard() {
        ...
        if (token) {
            ...
            switch (territoryType) {
                ...
                case 'region':
                case 'subregion':
                    window.location.href = 'http://localhost:8080/makueni-west/region/dashboard';
                    break;
                case 'church':
                    window.location.href = 'http://localhost:8080/makueni-west/church/dashboard';
                    break;
                default:
                    window.location.href = 'http://localhost:8080/makueni-west/church/dashboard';
            }
