...
$attemptedUrl = $_SESSION['attempted_url'] ?? '';

// Clear the session variables after reading
unset($_SESSION['required_permission']);
    ...
    <div class="page error-bg" id="particles-js">z
            ...
            <div class="container">
                <div class="text-center p-5 my-auto">
                    <div class="row align-items-center justify-content-center h-100">
                        <div class="col-xl-7">
                            <p class="error-text mb-sm-0 mb-2">403</p>
                            ...
                            <div class="row justify-content-center mb-4">
                                <div class="col-xl-8">
                                    <p class="mb-3 op-7">
                                        Sorry <?= htmlspecialchars($userName) ?>, you do not have permission to access
                                        this page.
                                    </p>
                                    <?php if ($requiredPermission !== 'Unknown'): ?>
                                    <div class="alert alert-danger" role="alert">
                                        <strong>Required Permission:</strong><br>
                                        <code
                                            style="color: #721c24; font-size: 14px;"><?= htmlspecialchars($requiredPermission) ?></code>
                                    </div>
                                    <?php endif; ?>
                                    <p class="mb-0 op-6" style="font-size: 14px;">
                                        If you believe this is an error, please contact your system administrator.
                                    </p>
                                </div>
                            </div>
                            <button onclick="backToDashboard()" class="btn btn-primary">
        ...
        function backToDashboard() {
            ...
            if (token) {
                ...
                const currentRole = JSON.parse(localStorage.getItem(Constants.STORAGE_KEYS.CURRENT_ROLE) || '{}');
                const territoryType = currentRole.territory_type || currentRole.territory?.territory_type;
