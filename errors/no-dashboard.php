...
<body>
        ...
        <div class="offcanvas-body">
            ...
            <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active border-0" id="switcher-home" role="tabpanel"
                    ...
                    <div class="navigation-menu-styles">
                        ...
                        <div class="px-4 pb-3 text-secondary fs-11">
                            <span class="fw-semibold fs-12 text-dark me-2 d-inline-block">Note:</span>Works same for
                    ...
                    <div class="sidemenu-layout-styles">
                        ...
                        <div class="px-4 pb-3 text-secondary fs-11">
                            <span class="fw-semibold fs-12 text-dark me-2 d-inline-block">Note:</span>Navigation menu
                            styles won't work here.
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-between canvas-footer">
                    <a href="https://themeforest.net/user/spruko/portfolio" class="btn btn-primary">Buy Now</a>
            ...
            <div class="container">
                <div class="text-center p-5 my-auto">
                    <div class="row align-items-center justify-content-center h-100">
                        <div class="col-xl-7">
                            <p class="error-text mb-sm-0 mb-2">⚠️</p>
                            ...
                            <div class="row justify-content-center mb-5">
                                <div class="col-xl-6">
                                    <p class="mb-0 op-7">
                                        We couldn't determine your default dashboard. This may be due to
                                        a configuration issue. Please contact your system administrator.
                                    </p>
                                </div>
                            </div>
                            <div id="territorialRoles" class="mb-4"></div>
                            <button onclick="logout()" class="btn btn-primary me-2">
                                <i class="ri-logout-circle-line align-middle me-1 d-inline-block"></i>
                                LOGOUT
                            </button>
                            <a href="mailto:support@makueniwestdiocese.org" class="btn btn-secondary">
                                <i class="ri-customer-service-2-line align-middle me-1 d-inline-block"></i>
    ...
    if (territorialRoles.length > 0) {
        const rolesContainer = document.getElementById('territorialRoles');
        let html =
            '<p class="mb-2 fw-semibold">Available Roles:</p><div class="d-flex flex-wrap gap-2 justify-content-center">';

        territorialRoles.forEach(role => {
            html +=
                `<span class="badge bg-secondary-transparent">${role.role_name} - ${role.territory_name}</span>`;
        });
    ...
    function logout() {
        ...
        localStorage.removeItem(Constants.STORAGE_KEYS.PERMISSIONS);
