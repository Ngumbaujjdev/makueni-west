...
<!-- Mirrored from spruko.com/demo/blazor/ynex/ynex/dist/html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 05 Jan 2024 16:04:17 GMT -->
    ...
    <div class="page">
                ...
                <div class="header-content-right">
                    ...
                    <div class="header-element cart-dropdown">
                        ...
                        <div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <div
                                                ...
                                                <ul class="header-product-item">
                                                    <li>Analog</li>
                                                    <li>
                                                        <span class="badge bg-pink-transparent fs-10">Free
                                                            shipping</span>
                                                    </li>
                                                </ul>
                                            </div>
                            ...
                            <div class="p-3 empty-header-item border-top">
                                <div class="d-grid">
                                    <a href="http://localhost:8080/makueni-west/my-payment/payment"
                                ...
                                <div class="row g-2">
                                        ...
                                        <a href="javascript:void(0);">
                                            <div class="text-center p-3 related-app">
                                                <span class="avatar avatar-sm avatar-rounded">
                                                    <img src="http://localhost:8080/makueni-west/assets/images/apps/figma.png"
                                                        alt="" />
                                                </span>
                                    ...
                                    <div class="col-4">
                                        <a href="javascript:void(0);">
                                            <div class="text-center p-3 related-app">
                                                <span class="avatar avatar-sm avatar-rounded">
                                                    <img src="http://localhost:8080/makueni-west/assets/images/apps/microsoft-powerpoint.png"
                                                        alt="" />
                                                </span>
                                    ...
                                    <div class="col-4">
                                        <a href="javascript:void(0);">
                                            <div class="text-center p-3 related-app">
                                                <span class="avatar avatar-sm avatar-rounded">
                                                    <img src="http://localhost:8080/makueni-west/assets/images/apps/microsoft-word.png"
                                                        alt="" />
                                                </span>
                                    ...
                                    <div class="col-4">
                                        <a href="javascript:void(0);">
                                            <div class="text-center p-3 related-app">
                                                <span class="avatar avatar-sm avatar-rounded">
                                                    <img src="http://localhost:8080/makueni-west/assets/images/apps/calender.png"
                                                        alt="" />
                                                </span>
                                    ...
                                    <div class="col-4">
                                        <a href="javascript:void(0);">
                                            <div class="text-center p-3 related-app">
                                                <span class="avatar avatar-sm avatar-rounded">
                                                    <img src="http://localhost:8080/makueni-west/assets/images/apps/sketch.png"
                                                        alt="" />
                                                </span>
                                    ...
                                    <div class="col-4">
                                        <a href="javascript:void(0);">
                                            <div class="text-center p-3 related-app">
                                                <span class="avatar avatar-sm avatar-rounded">
                                                    <img src="http://localhost:8080/makueni-west/assets/images/apps/google-docs.png"
                                                        alt="" />
                                                </span>
                                    ...
                                    <div class="col-4">
                                        <a href="javascript:void(0);">
                                            <div class="text-center p-3 related-app">
                                                <span class="avatar avatar-sm avatar-rounded">
                                                    <img src="http://localhost:8080/makueni-west/assets/images/apps/google.png"
                                                        alt="" />
                                                </span>
                                    ...
                                    <div class="col-4">
                                        <a href="javascript:void(0);">
                                            <div class="text-center p-3 related-app">
                                                <span class="avatar avatar-sm avatar-rounded">
                                                    <img src="http://localhost:8080/makueni-west/assets/images/apps/translate.png"
                                                        alt="" />
                                                </span>
                                    ...
                                    <div class="col-4">
                                        <a href="javascript:void(0);">
                                            <div class="text-center p-3 related-app">
                                                <span class="avatar avatar-sm avatar-rounded">
                                                    <img src="http://localhost:8080/makueni-west/assets/images/apps/google-sheets.png"
                                                        alt="" />
                                                </span>
                    ...
                    <div class="header-element">
                        ...
                        <ul class="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end"
                            ...
                            <li>
                                <a class="dropdown-item d-flex" href="mail.html"><i
                                        class="ti ti-inbox fs-18 me-2 op-7"></i>Inbox
                                    <span class="badge bg-success-transparent ms-auto">25</span></a>
                            </li>
                            <li>
                                <a class="dropdown-item d-flex border-block-end" href="to-do-list.html"><i
                                        class="ti ti-clipboard-check fs-18 me-2 op-7"></i>Task
                                    Manager</a>
                            </li>
                            <li>
                                <a class="dropdown-item d-flex" href="mail-settings.html"><i
                                        class="ti ti-adjustments-horizontal fs-18 me-2 op-7"></i>Settings</a>
                            </li>
                            <li>
                                <a class="dropdown-item d-flex border-block-end" href="javascript:void(0);"><i
                            ...
                            <li>
                                <a class="dropdown-item d-flex" href="sign-in-cover.html"><i
        ...
        <aside class="app-sidebar sticky" id="sidebar">
            ...
            <div class="main-sidebar-header">
                <a href="index.html" class="header-logo">
                    <img src="http://localhost:8080/makueni-west/assets/images/brand-logos/desktop-logo.png" alt="logo"
                        class="desktop-logo" />
                    <img src="http://localhost:8080/makueni-west/assets/images/brand-logos/toggle-logo.png" alt="logo"
                        class="toggle-logo" />
                    <img src="http://localhost:8080/makueni-west/assets/images/brand-logos/desktop-dark.png" alt="logo"
                        class="desktop-dark" />
                    <img src="http://localhost:8080/makueni-west/assets/images/brand-logos/toggle-dark.png" alt="logo"
                        class="toggle-dark" />
                    <img src="http://localhost:8080/makueni-west/assets/images/brand-logos/desktop-white.png" alt="logo"
                        class="desktop-white" />
                    <img src="http://localhost:8080/makueni-west/assets/images/brand-logos/toggle-white.png" alt="logo"
                        class="toggle-white" />
                </a>
            </div>
                    ...
                    <ul class="main-menu">
                        ...
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child1">
                                ...
                                <li class="slide has-sub">
                                    <a href="javascript:void(0);" class="side-menu__item">Email <i
                                            class="fe fe-chevron-right side-menu__angle"></i></a>
                                    <ul class="slide-menu child2">
                                        <li class="slide">
                                ...
                                <li class="slide">
                                    <a href="faq%27s.html" class="side-menu__item">FAQ's</a>
                                </li>
                                <li class="slide has-sub">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center fw-semibold">
                                                                <span class="avatar avatar-sm me-2 avatar-rounded">
                                                                    <img src="http://localhost:8080/makueni-west/assets/images/faces/8.jpg"
                                                                        alt="img" />
                                                                </span>Mirinda Hers
                                                            </div>
                                                        </td>
                                            ...
                                            <div class="card-header justify-content-between">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="javascript:void(0);">Month</a>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item" href="javascript:void(0);">Year</a>
                                                        </li>
                                                    ...
                                                    <ul class="list-unstyled mb-0 crm-recent-activity">
                                                        ...
                                                        <li class="crm-recent-activity-content">
                                                            <div class="d-flex align-items-top">
                                                                ...
                                                                <div class="crm-timeline-content">
                                                                    <span>New theme for
                                                                        <span class="fw-semibold">Spruko Website</span>
                                                                        completed</span>
                                                                    <span class="d-block fs-12 text-muted">Lorem ipsum,
                                                                        dolor sit amet.</span>
                                                                </div>
                                                                <div class="flex-fill text-end">
                                                                    <span class="d-block text-muted fs-11 op-7">3
                                                                        hrs</span>
                                                                </div>
                                                            </div>
                                                        </li>
                                                        <li class="crm-recent-activity-content">
                                                            <div class="d-flex align-items-top">
                                                                ...
                                                                <div class="flex-fill text-end">
                                                                    <span class="d-block text-muted fs-11 op-7">22
                                                                        hrs</span>
                                                                </div>
                                                            </div>
                                                        </li>
                                                        <li class="crm-recent-activity-content">
                                                            <div class="d-flex align-items-top">
                                                                ...
                                                                <div class="crm-timeline-content">
                                                                    <span>New member
                                                                        <span class="badge bg-pink-transparent">@andreas
                                                                            gurrero</span>
                                                        ...
                                                        <li class="crm-recent-activity-content">
                                                            <div class="d-flex align-items-top">
                                                                ...
                                                                <div class="crm-timeline-content">
                                                                    <span>Neon Tarly added
                                                                        <span class="text-info fw-semibold">Robert
                                                                            Bright</span>
                                                                        to AI summit project.</span>
                                                                </div>
                                                                <div class="flex-fill text-end">
                                                                    <span class="d-block text-muted fs-11 op-7">12
                                                                        hrs</span>
                                                                </div>
                                                            </div>
                                                        </li>
                                                        <li class="crm-recent-activity-content">
                                                            <div class="d-flex align-items-top">
                                                                ...
                                                                <div class="crm-timeline-content">
                                                                    <span>Replied to new support request
                                                                        <i
                                                                            class="ri-checkbox-circle-line text-success fs-16 align-middle"></i></span>
                                                                </div>
                                                                <div class="flex-fill text-end">
                                                                    <span class="d-block text-muted fs-11 op-7">4
                                                                        hrs</span>
                                                                </div>
                                                            </div>
                                                        </li>
                                                        <li class="crm-recent-activity-content">
                                                            <div class="d-flex align-items-top">
                                                                ...
                                                                <div class="crm-timeline-content">
                                                                    <span>Completed documentation of
                                                                        <a href="javascript:void(0);"
