             ...
             <div class="header-element">
                 ...
                 <a aria-label="Hide Sidebar"
                     ...
                     data-bs-toggle="sidebar" href="javascript:void(0);"><span
                         style="color: #064C4F!important;"></span></a>
                 <!-- End::header-link -->
             </div>
             <!-- End::header-element -->
         </div>
         ...
         <div class="header-content-right">
             ...
             <div class="header-element cart-dropdown">
                 ...
                 <a href="javascript:void(0);" class="header-link dropdown-toggle" data-bs-auto-close="outside"
                     ...
                     <span class="badge  rounded-pill header-icon-badge" style="background-color: #064C4F!important;"
             ...
             <div class="header-element notifications-dropdown">
                 ...
                 <a href="javascript:void(0);" class="header-link dropdown-toggle" data-bs-toggle="dropdown"
                     ...
                     <span class="badge rounded-pill header-icon-badge pulse pulse-secondary"
                         id="notification-icon-badge" style="background-color: #BA8448!important;">5</span>
                 </a>
                 <!-- End::header-link|dropdown-toggle -->
                 <!-- Start::main-header-dropdown -->
                 <!-- <div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                         ...
                         <div class="d-sm-block d-none">
                             <?php
                                ...
                                $admins=$app->select_all($query);   
                                    ?>
                             <?php foreach($admins as $admin): ?>
                             <p class="fw-semibold mb-0 lh-1"><?php echo $admin->Admin_firstname?></p>
                             <?php  endforeach; ?>
