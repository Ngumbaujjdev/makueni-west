...
<body>
                        ...
                        <div class="alert alert-warning d-none" id="guestNotice">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    For faster support, please <a href="/makueni-west/authentication/login"
    ...
    <!-- Gallery JS -->
    <script src="http://localhost:8080/makueni-west/assets/libs/glightbox/js/glightbox.min.js"></script>

    <!-- Internal Profile JS -->
    <script src="http://localhost:8080/makueni-west/assets/js/profile.js"></script>


    <!-- Dropzone JS -->
    <script src="http://localhost:8080/makueni-west/assets/libs/dropzone/dropzone-min.js"></script>
