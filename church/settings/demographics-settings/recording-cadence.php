...
$canWrite = hasPermission('church.settings.demographicssettings.recordingcadence.update');
...
<head>
    ...
    <title>Recording Cadence - Makueni West Diocese</title>
    <meta name="Description" content="Choose how often this church records demographics" />
    ...
    <script>
        ...
        const CAN_WRITE_RECORDING_CADENCE = <?= $canWrite ? 'true' : 'false' ?>;
    </script>
</head>
        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="alert alert-info bg-info-transparent border-0 mb-3">
                    ...
                    need a monthly submission by default. Half-yearly is the default for every church that hasn't
                    picked something else - change it any time below.
                </div>
                    ...
                    <div class="col-xl-6">
                        <div class="card custom-card">
                            <div class="card-header">
                                <div class="card-title"><i class="ri-calendar-2-line me-2 text-primary"></i>Recording Cadence</div>
                            </div>
